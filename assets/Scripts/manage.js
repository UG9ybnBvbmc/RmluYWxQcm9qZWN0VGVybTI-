                            ...
                            <td class="p-0" data-order="1">
                                ...
                                <div class="row justify-content-center justify-content-lg-between align-items-end me-3 pb-2">
                                    <div class="col-12 col-lg-12 d-flex justify-content-end p-0 m-0">
                                        ...
                                        <button class="btn btn-warning btn-data-table py-1 px-2 me-2" onclick="removeItem('${VALORANT_API}',${game.id})">ลบ&nbsp;&nbsp;<i class="fa-duotone fa-solid fa-clock-rotate-left"></i></button>
                                    </div>
                                </div>
                            </td>
                        </tr>
                            ...
                            <td class="p-0" data-order="1">
                                ...
                                <div class="row justify-content-center justify-content-lg-between align-items-end me-3 pb-2">
                                    <div class="col-12 col-lg-12 d-flex justify-content-end p-0 m-0">
                                        ...
                                        <button class="btn btn-warning btn-data-table py-1 px-2 me-2" onclick="removeItem('${FREEFIRE_API}',${game.id})">ลบ&nbsp;&nbsp;<i class="fa-duotone fa-solid fa-clock-rotate-left"></i></button>
                                    </div>
                                </div>
                            </td>
                        </tr>
